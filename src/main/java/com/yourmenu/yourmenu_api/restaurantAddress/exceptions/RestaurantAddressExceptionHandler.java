...
public class RestaurantAddressExceptionHandler {
    @ExceptionHandler(RestaurantAddressNotFoundException.class)
    public ResponseEntity<ErrorResponseDTO> handleRestaurantNotFoundException(RestaurantAddressNotFoundException e) {
